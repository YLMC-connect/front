...
> 마지막 갱신: 2026-05-26 (제공 ZIP 기준 toast 문구/offset, 디자인 viewport 캡처, Dev Client toolsButton=false 재설치 검증 반영) | 현재 Phase: 6 — API 연결 준비 (진행중)
...
|---|---|---|---|---|
| common (공통 인프라) | 2 | 1 | 2026-05-23 | [features/common.md](features/common.md) |
| auth (인증) | 2 | 1 | 2026-05-23 | [features/auth.md](features/auth.md) |
| market (나눔장터) | 1 | 1 | 2026-05-23 | [features/market.md](features/market.md) |
| group (소모임) | 1 | 1 | 2026-05-23 | [features/group.md](features/group.md) |
| mypage (MY) | 1 | 1 | 2026-05-23 | [features/mypage.md](features/mypage.md) |
| life-study (삶공부) | 1 | 1 | 2026-05-23 | [features/life-study.md](features/life-study.md) |
| prayer (중보기도) | 1 | 1 | 2026-05-23 | [features/prayer.md](features/prayer.md) |
