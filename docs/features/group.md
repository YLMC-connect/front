...
> 마지막 갱신: 2026-07-14 | 담당 Phase: P1/P3/P7 | 기록 성격: 도메인 컨텍스트
...
- 동행 glass sticky 헤더 — 소모임/봉사 세그먼트·카테고리 필터·카드 목록을 하나의 스크롤로 묶고 기본 배경색 기반 blur 타이틀 뒤로 지나가게 적용하며 검색·FAB 위치는 유지
