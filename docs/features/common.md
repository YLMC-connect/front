...
- 2026-05-27 삶공부 상세 정렬 후 비교 리포트의 상위 residual은 소모임 상세 일부, market-list, notifications, auth sheet/toast 계열입니다. `study-detail`은 ZIP `ScreenStudyDetail` 구조 반영으로 `20.90→9.39`까지 낮췄으며, 다음 우선순위는 group-detail 잔여 variant 또는 market-list 정렬입니다.
